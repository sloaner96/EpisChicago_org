...
<table border="0" cellpadding="3" cellspacing="0" width="100%">
  <tr>
		  ...
		  <cfelse>
		     <tr>
			   <td width="160" bgcolor="#f3f3f3">
					...
					<CFmodule template="#Application.CTMapping#/WebCal.cfm" EventCFM="ListEvents.cfm" GroupID="#GetGroupInfo.GroupID#" ContentID="#GetGroupContent.ContentCode#" PastDayColor="666666" TitleBar="No" ShowPrev="no">
					<br>
					<table width=160 border=0>
					<tr valign=top bgcolor="Navy">
					...
					<tr valign=middle>
						<td align=center>
							...
							<cfform method="POST" name="Keyword" action="SiteContent.cfm?GroupID=#GetGroupInfo.groupid#&GCID=#GetGroupContent.ContentCode#">
	...
	<td width="225" valign="top" align="right">
		<cfoutput><cfmodule template="sidenav.cfm" groupID="#groupID#" navimg="#GetGroupInfo.ImgName#" GroupName="#GetGroupInfo.GroupName#" showMembers="#GetGroupInfo.ShowMembers#">  </cfoutput>
      </td>
  </tr>
</table>
</cfmodule>