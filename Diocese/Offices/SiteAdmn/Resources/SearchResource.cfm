...
<CFMODULE Template="#Application.Header#"  pagetitle="Maintain Group Resource" subtitle="Search for a Resource">
							   ...
							   <cfif SrchResources.recordcount GT 0>
								...
								<cfform name="Add" action="UpdateResource.cfm?GroupID=#Url.groupID#&Action=SearchAdd" Method="POST">
							        <table border="0" cellpadding="2" cellspacing="1" width="100%">
									  ...
									  <tr>
									     <td align="center" colspan=4><input type="submit"  name="submit" value="Add Resources >>"></td>
									  </tr>
							        </table>
								</cfform>
						 <cfelse> <br><br>
