...
<CFMODULE Template="#Application.Header#" PageTitle="Diocesan Resources Admin" SubTitle="Main Menu">
		   ...
		   <cfif Error EQ "">	 
			   ...
			   <!--- Insert Resource Master Record --->
				 ...
				 <cfquery name="INsGroupResource" datasource="#Application.dsn#">
				   ...
				   Values(#form.GroupID#, #GetResource.ResourceID#, <cfif IsDefined("form.SubCatID")><cfif trim(form.SubCatID) NEQ "">'#form.SubCatID#'<cfelse>NULL</cfif><cfelse>NULL</cfif>,<cfif IsDefined("form.Highlight")>1<cfelse>0</cfif>)
				 </cfquery>
