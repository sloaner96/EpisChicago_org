...
<CFMODULE Template="#Application.Header#"  PageTitle="Site Administration" SubTitle="Modify Event Information">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<CFOUTPUT>
			  <input name="EventID" type="hidden" value="#URL.EventID#">
			  <input type="hidden" name="groupID" value="#URL.GroupID#">
			</cfoutput>
			<center>
			<table border=0 cellspacing=1 cellpadding=3 width=80% bgcolor="#F3F3F3">
...
<!--- 			<tr>
			...
			<tr>
				 ...
				 <td width=* align=left><input name="DiocesanWide" type="checkbox" value="1" <cfif DiocesanWide EQ 1>Checked</cfif>><font face="verdana" size="-2">(If checked this event must be approved by the site administrator, before it will be displayed on the diocesan homepage)</font></td>
			</tr>
			
			<tr>
				 <td width=120 align=left><font face="Verdana,Arial" size="-1"><b>Highlight in Group?</b></font></td>
				 <td width=* align=left><input name="GrpHighlight" type="checkbox" value="1" <cfif GrpHighlight EQ 1>Checked</cfif>></td>
			</tr>
