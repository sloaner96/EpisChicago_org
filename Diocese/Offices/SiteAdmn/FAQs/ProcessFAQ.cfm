...
<CFMODULE Template="#Application.Header#"  PageTitle="FAQ Processing">
			...
			<td valign="Top">
				...
				<cfelse>
					...
					<CFIF Left(Form.Cmd, 4) is "Save">
						...
						<CF_LogFile SiteID="#Application.SiteNfo.SiteID#" Action="New FAQ" Status="OK" Message="#Session.FullName#  added FAQ: '#Form.Question#'" User="#Session.subUserID#">
					...
					<CFELSEIF Left(Form.Cmd, "6") is "Delete">
						...
						<CF_LogFile SiteID="#Application.SiteNfo.SiteID#" Action="Delete FAQ" Status="OK" Message="#Session.FullName#  deleted FAQ: '#Form.Question#'" User="#Session.subUserID#">
					...
					<CFELSE>
						...
						<CF_LogFile SiteID="#Application.SiteNfo.SiteID#" Action="Update FAQ" Status="OK" Message="#Session.FullName# updated FAQ: '#Form.Question#'" User="#Session.subUserID#">
