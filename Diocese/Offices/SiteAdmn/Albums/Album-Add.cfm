...
<CFIF NOT #ErrorsFound#>
	...
	<CF_LogFile SiteID="#Application.SiteNfo.SiteID#" Action="New Album" Status="OK" Message="#Session.subuserFullName# created photo album #Alb.AlbumID#" User="#Session.subUserID#">
