...
<CFMODULE Template="#Application.Header#"  PageTitle="Site Administration" SubTitle="Group Programs">
   ...
   <td>
	<cfif url.action EQ "ADD">
	   ...
	   <table border="0" cellpadding="3" cellspacing="0" width="100%">
		 ...
		 <cfoutput>
		   <tr>
		      <td align="center"><font face="arial" size="-1"><a href="programs.cfm?groupID=#url.groupID#">Click Here</a> to administer more programs</font></td>
		   </tr>
		 </cfoutput>
       </table>
	...
	<cfelse>
		...
		<table border="0" cellpadding="3" cellspacing="0" width="100%">
		  <tr>
		      <td><font face="arial" size="-1">Add the upcoming or currently active programs to your group subsite below. If your group or office has upcoming programs you would like to have added please contact <a href="mailto:dskidmore@episcopalchicago.org">David Skidmore</a> to have your program added to the diocesan program calendar.</font></td>
		  </tr>
		  <tr>
		    <td>&nbsp;</td>
		  </tr> 
		  <cfif GetPrograms.recordcount GT 0>
			  ...
			  <cfform name="addprogram" action="programs.cfm?action=Add&GroupID=#url.groupID#" method="POST">
				  <tr>
				   ...
				   <table border="0" cellpadding="3" cellspacing="1" width="100%">
			         <tr bgcolor="eeeeee">
					  ...
					  <tr>
						...
						<td width="30%"><font face="verdana" size="-2"><a href="programs.cfm?action=remove&ProgID=#MyPrograms.ProgramID#&GroupID=#url.groupID#" style="font-color:red;">[REMOVE FROM SITE]</a></font></td>
					  </tr>
					  </cfoutput>
			       </table>
				</td>
