	...
	<table border="0" cellpadding="3" cellspacing="0" width="100%">
	  <tr>
				   ...
				   <cfoutput>
					  <tr>
					    <td><font face="verdana" size="-1">
					         ...
					         <cfif Description is not ""><font face="verdana" size="-2">#Description#</font><br></cfif>
		...
		<td width="225" valign="top" align="right">
		   <cf_bsidenav imgname="#GetGroupInfo.ImgName#" groupname="#GetGroupInfo.GroupName#" showmembers ="1">
		</td>
	  </tr>
	</table> 
