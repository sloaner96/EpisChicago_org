...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
   <tr>
		...
		<cfif url.action EQ "Add">
		   <!--- Error Checking --->
		      <cfif Len(Trim(form.RecLabel)) EQ 0>
			    <cflocation url="AddResource.cfm?E=1" addtoken="No">
			  </cfif>
			  
			  <cfif Len(Trim(form.ResType)) EQ 0>
			    <cflocation url="AddResource.cfm?E=2" addtoken="No">
			  </cfif>
			  
			  <cfif Len(Trim(form.CatiD)) EQ 0>
			    <cflocation url="AddResource.cfm?E=3" addtoken="No">
			  </cfif>
		
			  
			  <cfif form.ResType EQ "L" >
			     <cfif Len(Trim(form.RecLinkLabel)) EQ 0>
			        <cflocation url="AddResource.cfm?E=4" addtoken="No">
			     </cfif>
			  ...
			  <cfelseif form.ResType EQ "S">
			      <cfif Len(Trim(form.RecEmailLabel)) EQ 0>
			        <cflocation url="AddResource.cfm?E=5" addtoken="No">
			     </cfif>
		   ...
		   <cfif Error EQ "">	 
		       ...
		       <cfelseif form.ResType EQ "S">
				  ...
				  <cfelse>
					 ...
					 <cfelse>
					   <cfset ThisFile = "">	
					   <cflocation url="AddResource.cfm?E=6" addtoken="No">
					 </cfif>
			   ...
			   <!--- Insert Resource Master Record --->
			       ...
			       Insert Into Resources (
					...
					Values (
						...
						#ThisContentID#,
						'#form.CatID#',
						<cfif IsDefined("form.SubCatID")><cfif form.SubCatID NEQ "">'#form.SubCatID#'<cfelse>NULL</cfif><cfelse>NULL</cfif>,
						<cfif IsDefined("form.IsActive")>#form.IsActive#<cfelse>0</cfif>,
						<cfif IsDefined("form.IsHighlight")>#form.IsHighlight#<cfelse>0</cfif>,
	...
	<cfelseif url.action EQ "Update">
			 ...
			 <!--- Error Checking --->
		      <cfif Len(Trim(form.RecLabel)) EQ 0>
			    <cflocation url="EditResource.cfm?E=1&ResID=#Form.ResourceID#" addtoken="No">
			  </cfif>
			  
			  <cfif Len(Trim(form.ResType)) EQ 0>
			    <cflocation url="EditResource.cfm?E=2&ResID=#Form.ResourceID#" addtoken="No">
			  </cfif>
			  
			  <cfif Len(Trim(form.CatiD)) EQ 0>
			    <cflocation url="EditResource.cfm?E=3&ResID=#Form.ResourceID#" addtoken="No">
			  </cfif>
		
			  
			  <cfif form.ResType EQ "L" >
			     <cfif Len(Trim(form.RecLinkLabel)) EQ 0>
			        <cflocation url="EditResource.cfm?E=4&ResID=#Form.ResourceID#" addtoken="No">
			     </cfif>
				 <cfif Len(Trim(form.RecLink)) EQ 0>
			        <cflocation url="EditResource.cfm?E=4&ResID=#Form.ResourceID#" addtoken="No">
			     </cfif>
			  ...
			  <cfelse>
			   ...
			   <!--- Insert Resource Master Record --->
			       ...
			       Update Resources 
				       Set  ResourceLabel = '#TempLabel#',
							...
							Highlight =<cfif IsDefined("form.Ishighlight")>#form.IsHighlight#<cfelse>0</cfif>,
			   ...
			   <!--- Kick back to homepage --->
			     <cflocation url="index.cfm?s=2" addtoken="No">
		...
		<cfelseif url.action EQ "Confirm">
		  ...
		  <cfoutput>
			  <tr>
			    <td align="center"><font face="arial" size="+1"><a href="UpdateResource.cfm?action=Delete&ResID=#url.ResID#" style="color:##009900;">YES</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.cfm" style="color:##cc0000;">NO</a></font></td>
			  </tr>
		  </cfoutput>
		<cfelseif url.action EQ "Delete">
		  ...
		  <cfif GetRes.recordcount GT 0>
			  ...
			  <cfquery name="DeleteGroupRes" datasource="#application.dsn#">
				...
				where ResourceID = #GetRes.ResourceID# 
			  </cfquery>
			  
			  <cfquery name="DeleteResGrouping" datasource="#application.dsn#">
		  ...
		  <cflocation url="index.cfm?s=3" addtoken="No">
		<cfelseif url.action EQ "Approve">
		   <cfif IsDefined("form.Resources")>
		      <cfif listLen(form.Resources) GT 0>
				 ...
				 <cflocation url="ApproveResource.cfm?S=1" addtoken="No">
			  <cfelse>
			    <cflocation url="ApproveResource.cfm?e=1" addtoken="No">	 
			  </cfif>
		   <cfelse>
		      <cflocation url="ApproveResource.cfm?e=1" addtoken="No">
		   </cfif>
