...
<tr>
	...
	<td width=448 align=left><cfselect name="Section" size=1 query="FAQsites" Value="CodeValue" display="CodeDesc" selected="#Section#" required="Yes" Message="A Site for these FAQs must be specified"></cfselect></td>
</tr>
