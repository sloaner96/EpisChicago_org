...
<CFMODULE Template="#Application.Header#" Section="Admin"  pagetitle="Maintain Member Roster">
<cfoutput>
<div align="right"><a href="/admin/subsites/index.cfm?groupID=#url.groupid#"><font face="tahoma" size="-1">Back to Subsite Admin</font></a></div>
</cfoutput>
<br>
	  ...
	  <br>	<center>
	   <table border="0" cellpadding="3" cellspacing="1" width="100%" bgcolor="eeeeee">
	        <tr bgcolor="#6d6d6d">
			  ...
			  <td><font face="verdana" color="ffffff" size="-1"><strong>Address</strong></font></td>
	  ...
	  <cfif Getmembers.recordcount GT 0>
          <cfoutput query="GetMembers">
			    <tr bgcolor="ffffff">
				   ...
				   <td valign="top"><font face="arial" size="-1">#GetMembers.Address1#<br><cfif GetMembers.address2 NEQ "">#GetMembers.Address2#<br></cfif><cfif GetMembers.City NEQ "">#GetMembers.City#, #GetMembers.State# #GetMembers.ZipCode#</cfif></font></td>
				   <td valign="top"><font face="arial" size="-1">#GetMembers.Phone#</font></td>
				   <td align="center"><font face="verdana" size="-1"><a href="EditRoster.cfm?ID=#Getmembers.MemberID#&GroupID=#Url.GroupID#">EDIT</a> | <a href="UpdateRoster.cfm?GroupID=#Url.GroupID#&ID=#MemberID#&Action=Delete" style="color:red">REMOVE<a/></font></td>
	            </tr>
		  </cfoutput>
	   <cfelse>
