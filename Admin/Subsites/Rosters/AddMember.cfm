...
<CFMODULE Template="#Application.Header#"  Section="Admin" pagetitle="Search For a Member">
<cfoutput>
						   ...
						   <table border="0" cellpadding="0" cellspacing="0" width="100%">
							 ...
							 <tr>
							   <td>&nbsp;</td>
								 ...
								 <form name="AddExMember" action="AddMember_Step2.cfm?GroupID=#Url.GroupID#&Type=#Url.Type#" Method="POST">
									 <tr>
										<td>
										  <table border="0" cellpadding="0" cellspacing="0">
											<cfloop query="GetMember">
											  <tr>
									   			 <td width="5"><input type="radio" name="ExMbr" value="#GetMember.MemberID#" <cfif GetMember.recordcount EQ 1>Checked</cfif>></td>
									 ...
									 <tr>
									   <td><input type="submit" name="submit" value="Select Member >>"></td>
									 </tr>
								 </form>
							 </table>
							</cfif>
