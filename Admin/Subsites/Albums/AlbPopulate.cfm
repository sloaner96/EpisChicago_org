...
<tr valign=top>
	<td width=50% align=left><a href="UpdAlbum.cfm?AlbumID=#AlbumID#&GroupID=#url.groupID#"><font face="Tahoma" color="Blue" size="-1">Return to Album Page</font></a></td>
	<td width=50% align=right><a href="/Albums/album.cfm?AlbumID=#AlbumID#&GroupID=#url.groupID#" target="_blank"><font face="Tahoma" color="Blue" size="-1">View Photo Album</font></a></td>
</tr>
</table>
</center>
...
<CFIF Alb.RecordCount gt 0>
	...
	<tr><td>
		<cfform name="PhotoList" action="Photo-Update.cfm">
			...
			<cfgrid name="UpdAlbum" width="600" query="Photos" insert="No" delete="Yes" sort="Yes" font="Tahoma" bold="No" italic="No" autowidth="true" appendkey="No" highlighthref="No" griddataalign="LEFT" gridlines="Yes" rowheaders="Yes" rowheaderalign="LEFT" rowheaderitalic="No" rowheaderbold="No" colheaders="Yes" colheaderalign="CENTER" colheaderitalic="No" colheaderbold="Yes" selectmode="EDIT" picturebar="No">
