...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<tr>
				 <td width=120 align=left><font face="Verdana,Arial" size="-1"><b>Diocesan Wide?</b><font face="verdana" size="-2">(If checked this event must be approved by the site administrator, before it will be displayed on the diocesan homepage)</font></font></td>
				 <td width=* align=left><input name="DiocesanWide" type="checkbox" value="1" <cfif DiocesanWide EQ 1>Checked</cfif>></td>
			</tr>
