...
<CFMODULE Template="#Application.Header#" Section="Admin"  PageTitle="Site Administration" SubTitle="Enter new Group Calendar Event">
...
<!--- 			<tr>
			...
			<tr>
				...
				<td width=* align=left><input name="DiocesanWide" type="checkbox" value="1"></td>
			</tr>
			<tr>
