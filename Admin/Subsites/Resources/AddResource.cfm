...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
   <tr>
	 ...
	 <td valign="top">
	    <br>
		<p><font face="arial" size="-1">Use the form below to add a new group resources.</font></p> 
		<hr noshade size=1>
		<cfoutput>
	    <cfif Url.E EQ 1>
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<table border="0" cellpadding="3" cellspacing="0" width="100%">
		   ...
		   <tr bgcolor="eeeeee">
		     <td><font face="verdana" size="-1"><strong>Highlight Resource:</strong></font> <input type="checkbox" name="Highlight" value="1"></td>
		   </tr>
		   <tr>
		     <td>&nbsp;</td>
		   </tr>
