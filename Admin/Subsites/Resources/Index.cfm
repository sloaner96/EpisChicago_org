...
<CFMODULE Template="#Application.Header#" Section="Admin"  pagetitle="Maintain Group Resource">
			   ...
			   <cfoutput>
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
					  <tr>
					    ...
					    <td align="right"><a href="/admin/subsites/index.cfm?groupID=#url.groupid#"><font face="tahoma" size="-1">Back to Subsite Admin</font></a></td>
					  </tr>
					</table><br>
				</cfoutput>
			   <cfif ActiveResources.recordcount GT 0>
		        ...
		        <table border="0" cellpadding="2" cellspacing="1" width="100%">
				  ...
				  <cfoutput query="ActiveResources" startrow="#url.nstart#" maxrows="#RowsPerPage#">
				    <tr>
					  <td><font face="verdana" size="-2"><a href="UpdateResource.cfm?Action=Confirm&ResID=#ActiveResources.ResourceID#&groupID=#url.groupid#" style="color:##cc0000;">[DELETE]</a></font></td>
					  ...
					  <td><a href="EditResource.cfm?ResID=#ActiveResources.ResourceID#&groupID=#url.groupid#"><font face="verdana" size="-1">#ResourceLabel#</strong></font></a></td>
				    </tr>
				  </cfoutput>
		        </table>
			 <cfelse> <br><br>
