...
<HEAD>
	...
	<TITLE>Chicago Diocese -- Youth Ministry Calendar</TITLE>
</head>

<cfmodule template="#Application.header#" Section="Ministry" PageTitle="Youth Ministries"
	SubTitle="Youth Ministries Calendar">
